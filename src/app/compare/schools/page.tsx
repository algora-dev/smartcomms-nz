 ...
 */
const REVIEW_DATE = reviewedDate("/compare/schools");
const REVIEW_LABEL = reviewedLabel("/compare/schools");
...
const pageUrl = `${site.url.replace(/\/$/, "")}/compare/schools`;
...
export default function ComparePage() {
  const article = {
    ...articleSchema({
      ...
      description: PAGE_DESCRIPTION,
      url: pageUrl,
      datePublished: publishedDate("/compare/schools"),
  ...
  return (
    <article aria-labelledby="compare-title">
      ...
      <section id="nz-school-examples" aria-labelledby="nz-school-examples-title" className="sc-container sc-container-reading scroll-mt-24 py-12">
        ...
        <div className="mt-6">
          ...
          <ProjectHelpLauncher
            ...
            context={{ sourcePage: "/compare/schools", topic: "Published NZ school project examples" }}
          />
        </div>
      </section>
      ...
      <JsonLd data={breadcrumbSchema([
        ...
        { name: "Compare systems", url: `${site.url.replace(/\/$/, "")}/compare` },
        { name: "Schools", url: pageUrl },
      ])} />
