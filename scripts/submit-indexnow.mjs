 ...
 * Default: https://smartcomms.co.nz/sitemap.xml
 * Key file must be deployed at https://smartcomms.co.nz/<KEY>.txt
 * (Full-sitemap mode, same pattern as the t3-labs and quotecore-plus scripts.)
 */

import fs from 'node:fs';
import path from 'node:path';

const INDEXNOW_KEY = 'ec40e92fce373cb14a6fca2e1112da1a';
const INDEXNOW_URL = 'https://api.indexnow.org/IndexNow';
const SITEMAP_URL = process.argv[2] || 'https://smartcomms.co.nz/sitemap.xml';
